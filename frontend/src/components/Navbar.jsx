  ...
  return (
    <nav className={styles.navbar}>
      <Link to="/" className={styles.brand}>
        <img src={logo} alt="Logotipo" width="150" height="40" />
      </Link>
      ...
      {/* Adicione a classe 'open' condicionalmente */}
      <ul className={`${styles.navList} ${menuOpen ? styles.open : ''}`}>
        ...
        {isAdmin && (
          <li onClick={() => setMenuOpen(false)}><NavLink to="/adicionar-sala">Adicionar Sala</NavLink></li>
        )}
        <li>
          {isAdmin ? (
